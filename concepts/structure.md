...
<img src="https://www.helioseducore.com/wp-content/uploads/2019/01/states-of-matter-PNG-e1548859104853.png" />
...
<a title="Dave3457, Public domain, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Circular.Polarization.Circularly.Polarized.Light_Right.Handed.Animation.305x190.255Colors.gif"><img width="256" alt="Circular.Polarization.Circularly.Polarized.Light Right.Handed.Animation.305x190.255Colors" src="https://upload.wikimedia.org/wikipedia/commons/8/81/Circular.Polarization.Circularly.Polarized.Light_Right.Handed.Animation.305x190.255Colors.gif"></a>
...
<!--
It can be summarized as a remarkably short list of only 17 particles (and their antiparticles):

6 leptons arranged in 3 generations of similar pairs:  (electron, electron-neutrino), (muon, muon-neutrino), (tauon, tau-neutrino).
6 quarks arranged in 3 generations of similar pairs: (up, down), (charm, strange), (top, bottom)
4 force-carrying (gauge, vector) bosons: photon (electromagnetic force); Z, W (weak force); gluon (strong force)
1 mass-giving (scalar) boson: Higgs

These 17 particles are distinguished from each other by 4 fundamental properties:

energy-momentum :
includes rest-mass (how heavy they are when not moving)
dictates how much they feel the gravitational force
always positive
charge
dictates how much they feel the electromagnetic force and the weak force
can be either positive or negative (like signs repel and opposite signs attract) or zero (neutral)
color charge
dictates how much they feel the strong force
can be one of three values (red, green, blue) with neutral color charge being called (white)
angular momentum (spin)
distinguishes fermions (half-integer spin) from bosons (integer spin)
affects multi-particle behavior (solid, fluid, and gas properties)

All other complex phenomena we observe must arise from interesting structures and motion composed of these basic things.

The only missing piece to the standard model that we observe is gravity. There is strong suspicion that it must be mediated by a graviton in a similar way to the other forces, but currently we don't have a unified theory that clarifies its properties (other than likely being a spin-2 boson with no rest-mass or charges), and we don't have sensitive enough detectors to confirm its existence. In fact, there are sound arguments that we cannot ever build a detector that can verify individual gravitons because any detector large and sensitive enough will collapse into a black hole or cause other problems.

There are still a few remaining fundamental questions (such as why there are 3 generations of leptons and quarks, why neutrinos seem to evolve into each other, etc.), but otherwise the Standard Model correctly describes all collected data from all particle accelerators from decades of observations. It is the most successful physical theory we have, and there is no experimental indication yet that we can expect much more to be added besides gravity.
-->
